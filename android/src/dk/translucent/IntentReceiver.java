...
import dk.translucent.MoodKickActivity;
...
public class IntentReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (action.equals(PushManager.ACTION_PUSH_RECEIVED)) {
			...
			Logger.info("Received push notification. Alert: " + alert + ". Payload: " + extras.toString() + ". NotificationID=" + id);
			...
			launch.setClass(UAirship.shared().getApplicationContext(), MoodKickActivity.class);
		...
		} else if (action.equals(UALocationManager.ACTION_LOCATION_SERVICE_BOUND)) {
			try {
